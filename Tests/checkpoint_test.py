...
model = WhisperForConditionalGeneration.from_pretrained("Models/whisper-small-test/checkpoint-2000")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="Models/whisper-small-test",  # name on the HF Hub
...
trainer.train("Models/whisper-small-test/checkpoint-2000")
