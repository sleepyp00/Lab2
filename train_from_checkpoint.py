...
from augment import time_mask, freq_mask
...
model = WhisperForConditionalGeneration.from_pretrained("Models/whisper-small-sv-test2/checkpoint-4000")
...
trainer.train("Models/whisper-small-sv-test2/checkpoint-4000")
